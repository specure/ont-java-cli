...
public class RMBTApplet extends Applet {
    ...
    public void init() {
        ...
        final String customer = getParameter("customer");
        final Boolean legacy = Boolean.valueOf(getParameter("legacy"));
            ...
            public void run() {
                try {
                    ...
                    if (runRMBT) {
                        ...
                        client = RMBTClient.getInstance(customer, legacy, getParameter("host"), getParameter("path"),
                        ...
                        if (runQoS && client.getStatus() == TestStatus.SPEEDTEST_END) {
                            ...
                            try {
                                ...
                                if (qosResult != null && qosTest.getStatus().equals(QoSTestEnum.QOS_FINISHED)) {
                                    ...
                                    client.sendQoSResult(customer, qosResult);
                                }
                    ...
                    if (runNdt && (client.getStatus() == TestStatus.QOS_END || client.getStatus() == TestStatus.SPEEDTEST_END)) {
                        ...
                        ndtRunner.runNDT(NdtTests.NETWORK_WIRED, ndtRunner.new UiServices() {
                            ...
                            public void sendResults() {
                                ...
                                csc.sendNDTResult(customer, legacy, getParameter("host"), getParameter("path"),
