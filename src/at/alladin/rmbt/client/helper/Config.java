...
public abstract interface Config {
    ...
    public static final String RMBT_VERSION_NUMBER = "1.2.1";
    ...
    public static final String RMBT_LEGACY_CONTROL_PATH = "/ControlServer";
    public static final String RMBT_LEGACY_CONTROL_MAIN_URL = "/";
    public static final String RMBT_CONTROL_PATH = "";
    public static final String RMBT_CONTROL_MAIN_URL = "/testRequest";
