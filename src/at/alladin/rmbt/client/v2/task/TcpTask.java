...
//			if (result.getTestType() == QoSTestResultEnum.TCP) {
//                String uid = result.getResultMap().get("qos_test_uid").toString();
//                if (uid.startsWith("99")) {
//                    System.out.println("Found SSH test!");
//                }
//            }
