...
public final class BandCalculationUtil {
    ...
    public static class FrequencyInformation<U extends Band> {
        ...
        /**
         * Use this for Download frequency
         *
         * @return
         */
        ...
        /**
         * Use this for Upload frequency
         *
         * @return
         */
        public double getFrequencyULfromDL() {

            double downloadFrequencyLowerBound = this.band.download_frequency_lower_bound;
            double uploadFrequencyLowerBound = this.band.upload_frequency_lower_bound;

            double actualFrequencyDL = this.band.getFrequencyDL(earfcn);

            double difference = actualFrequencyDL - downloadFrequencyLowerBound;

            double uploadFrequency = uploadFrequencyLowerBound + difference;
         ...
         * @return
         */
        private double getFrequencyUL() {
            return this.band.getFrequencyUL(earfcn);
        }
        ...
        public double getBandwidth() {
            return this.band.download_frequency_upper_bound - this.band.download_frequency_lower_bound;
        }
    ...
    public static abstract class Band {
        ...
        /**
         * @param channel
         * @return 0 if there is not upload frequency
         */
